...
class MuhammadHarisChaidir extends WebDeveloper implements UIUXDesigner
{
    public const BRAND   = "haris.uix";
    ...
    public string $phone    = "0895-3762-57021";
    public int    $exp      = 3; // years
    ...
    public array $techStack = [
        ...
        "Tools"     => ["Git", "REST API", "WhatsApp API"],
    ];
    ...
    public array $specializations = [
        ...
        "Web App Terintegrasi WhatsApp API",
        "UI/UX Research, Design & Prototyping",
    ];

    public function workflow(): string
    {
        return "Analisa → Wireframe → Desain → Develop → Test → Deploy → Maintain";
    }

    public function status(): string
    {
        return "🟢 Open to new projects & collaborations";
    }
}
```
...
| 💅 **SI Klinik Mutiavie** | Klinik + Kasir | PHP · MySQL | ![Done](https://img.shields.io/badge/✓_DONE-FF0000?style=flat-square) |
| 🛒 **POS + Inventory System** | Kasir & Stok | PHP · MySQL | ![Done](https://img.shields.io/badge/✓_DONE-FF0000?style=flat-square) |
| 💬 **SI Keluhan RSU** | Keluhan Digital | PHP · WhatsApp API | ![Done](https://img.shields.io/badge/✓_DONE-FF0000?style=flat-square) |
| 📱 **SI Deposit Pulsa** | Web App | PHP · WhatsApp API | ![Done](https://img.shields.io/badge/✓_DONE-FF0000?style=flat-square) |
...
[![WhatsApp](https://img.shields.io/badge/💬_WhatsApp-0895--3762--57021-25D366?style=for-the-badge&labelColor=0d0d0d)](https://wa.me/62895376257021)
